#!/usr/bin/python3
"""
Rectangle class to include a static method bigger_or_equal
(rect_1, rect_2) that compares two rectangles based
on their areas and returns the biggest rectangle.
"""
